...
-- -----------------------------------------------------
-- Table `bd_imesys`.`especialidades` ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`datos_biometricos`    ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`historial_consultas`    ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`historial_paciente`    ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`imagenes_medicas`    ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`recompensas`    ok
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `bd_imesys`.`resultados_ia`    ok
-- -----------------------------------------------------
...
-- Tabla de Clasificación de Médicos    ok
...
VALUES
(13, 1, 3, 'El doctor fue amable, pero la atención demoró un poco.', FALSE),
(13, 2, 4, 'Buena atención, explicó todo con claridad.', FALSE),
(13, 3, 2, 'No me sentí muy cómodo con la consulta.', TRUE),
(12, 3, 5, 'Excelente médico, muy profesional y puntual.', FALSE),
(12, 3, 5, 'Me ayudó muchísimo con mi tratamiento.', TRUE);

INSERT INTO agenda_medico (id_medico, fecha_hora, estado, etiqueta, recordatorio)
VALUES
(2, '2025-04-23 09:00:00', 'Disponible', 'Consulta general', 'Mañana disponible para consultas regulares'),
(2, '2025-04-24 15:30:00', 'No disponible', 'Reunión interna', 'Reunión con equipo médico para revisión de casos');
