...
<head>
    ...
    <title>Administración de Datos Biométricos - Imesys</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" crossorigin="anonymous">
    <style>
        /* Estilos para tema médico */
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1><i class="fas fa-heartbeat"></i> Administración de Datos Biométricos</h1>
        ...
        <div id="crear" class="tab-content">
            ...
            <div class="form-container">
                <form id="crear-form">
                    ...
                    <div class="form-group">
                        <label for="resultado_prediccion">Resultado de Predicción</label>
                        <input type="text" id="resultado_prediccion" name="resultado_prediccion">
                    </div>
    ...
    <script>
        // URLs de la API
        const API_URL = 'http://localhost:5000/api/datos_biometricos';
        ...
        // Cargar todos los datos biométricos
        ...
        crearForm.addEventListener('submit', async (e) => {
            ...
            const nuevoDato = {
                ...
                resultado_prediccion: document.getElementById('resultado_prediccion').value
            };
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('Error al crear el dato biométrico');
                }
                
                const result = await response.json();
                mostrarNotificacion('Dato biométrico creado correctamente con ID: ' + result.id, 'success');
                crearForm.reset();
        ...
        searchButton.addEventListener('click', async () => {
            ...
            try {
                ...
                let url = tipo === 'id_dato' ? `${API_URL}/${id}` : `${API_URL}/usuario/${id}`;
